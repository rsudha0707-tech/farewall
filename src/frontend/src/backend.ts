...
export class Backend implements backendInterface {
    ...
    async addBlocklistEntry(arg0: string, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addBlocklistEntry(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addCallHistory(arg0: string, arg1: string, arg2: string, arg3: boolean): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addCallHistory(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBlocklist(): Promise<Array<BlocklistEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBlocklist();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecentBlocked(): Promise<Array<CallHistory>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentBlocked();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalBlocked(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalBlocked();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeBlocklistEntry(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeBlocklistEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateContact(arg0: bigint, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
